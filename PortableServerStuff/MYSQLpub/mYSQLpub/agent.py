...
class Mysqlpub(Agent):
    ...
    def _handle_publish(self, peer, sender, bus, topic, headers,
        ...
        messagekeys=['Main_P', 'Main_Q', 'P_G8', 'P_G9', 'P_G2']
        messagekeys2=['Main_P', 'Main_Q', 'P_G8', 'P_G9', 'P_G2', 'P_G3', 'P_G1', 'P_G1', 'P_G6', 'P_G7', 'P_G4', 'P_G5']
        if x>0:
            BEMStag=topic.split("/")
            index=BEMStag[-2]
            ...
            for k2 in messagekeys2:
                self.MYSQLMessage2[str(index)+'_'+k]=int((message[0])[k])/10
            self.MYSQLMessage3[str(index)]=message[0]
    ...
    def MYSQLpublish(self):
        ...
        MYSQLtopic2 = 'record/benshee/Monitor/all'

#        result = self.vip.pubsub.publish(peer='pubsub',topic=MYSQLtopic, headers=header,message=self.MYSQLMessage)
       
        result = self.vip.pubsub.publish(peer='pubsub',topic=MYSQLtopic2, headers=header,message=self.MYSQLMessage3)
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
