...
def lPControl(config_path, **kwargs):
    """
    ...
    return Lpcontrol(setting1, setting2, **kwargs)
def listen(client, userdata, message):
    global message1
    message1=message
    print("got the message")
    if message.topic=="devices/wemo_c/shed":
        Lpcontrol.Shedding_Command=1
        Lpcontrol.User_Command=1
        Lpcontrol.Shedding_Amount=message.payload

	
def connect(client, userdata, flags,rc):
    _log.debug("#######################MQTT client is connected###################")   

class Lpcontrol(Agent):
    """
    ...
    def __init__(self, setting1=1, setting2="some/random/topic", **kwargs):
        super(Lpcontrol, self).__init__(**kwargs)
        ...
        self.client1.connect("127.0.0.1",1884)
        ...
        Temp1={}
        Temp2={}
        csv_path='/home/pi/Config/Buildings_Config.csv'
        WeMo_Priorities={}
    ...
    def Schedule_WeMo(self):
        ...
        for x,y in self.WeMo_Priorities.items():
           ...
           # print(y)
            ...
            Scheduled_Total__WeMo_Consumption=int(self.Power_Consumption_Upper_limit)+int(Lpcontrol.Shedding_Amount)
            print("WeMoooooo consumptionnn"+str(self.Power_Consumption_Upper_limit)+"hhhhhhhhhhhh"+str(Lpcontrol.Shedding_Amount))
    ...
    def Check_Shedding_condition(self):
      ...
      #  self.publish_to_sql(self.Power_Consumption_Upper_limit,total_consumption,Lpcontrol.Shedding_Amount)
        if Lpcontrol.Shedding_Command == 1 :
            self.Power_Consumption_Upper_limit=total_consumption-int(Lpcontrol.Shedding_Amount)
    ...
    def Load_Priority(self):
        ...
        if Lpcontrol.Shedding_Command == 1 or over_consumption_flag==1:
            
            self.WeMo_Scheduled_Status=self.Schedule_WeMo()
            
            Lpcontrol.Shedding_Command=0
        ...
        print(str(Lpcontrol.Shedding_Command)+'*******************************end of the function*************************'+str(self.WeMo_Scheduled_Status))
