...
def lPCINCAgent(config_path, **kwargs):
    ...
    return Lpcincagent(setting1,
                          setting2,
                          **kwargs)


class Lpcincagent(Agent):
    ...
    def __init__(self, setting1=1, setting2="some/random/topic",
                 **kwargs):
        super(Lpcincagent, self).__init__(**kwargs)
    ...
    def _handle_publish(self, peer, sender, bus, topic, headers,
        ...
        if topic=="control/plc/shedding":
            Lpcincagent.Shedding_Command=1
            Lpcincagent.User_Command=1
            Lpcincagent.Shedding_Amount=int(message)
