...
def LoadProrityAgent(config_path, **kwargs):
    ...
    return Loadprorityagent(setting1, setting2, **kwargs)
...
class Loadprorityagent(Agent):
    ...
    def __init__(self, setting1=1, setting2="some/random/topic", **kwargs):
        ...
        self.default_config = {"setting1": setting1,
                               "setting2": setting2}
        self.client1= paho.Client("control2")
        ...
        Temp1={}
        Temp2={}
        csv_path='/home/sanka/volttron8/volttron/LoadPrority/WeMo_Config2.csv'
        WeMo_Priorities={}
        config_dict = utils.load_config('/home/sanka//volttron8/volttron/LoadPrority/WeMo_Config2.csv')
